...
<body class="container">
    ...
    <section>
        ...
        <p>I'm currently a student at the University of Rochester, class of 2021.
            ...
            complex worlds,I like to write and draw in my spare time.
        </p>
    </section>
    ...
    <section>
        ...
        <p> Up until high school, I had mostly focused on writing and dabbled
            ...
            with my friends. However, being that I was attending a writing school, I was not only
            able to technically enhance my writing skills, but I was also introduced
            to my first Computer Science class. That class allowed me to learn
            programming at a much faster rate and would lead me into the world of
            robotics briefly as the Computer Science teacher recruited me for the
        ...
        <div class="grid">
            <div class="i">
                ...
                <p> Since entering the U of R, I've taken a host of Computer Science classes
                    ...
                    which has expanded my skillset and helped me to understand what I want to pursue
                    as a career. In the summer, I was hired as part of a online retail start up.
