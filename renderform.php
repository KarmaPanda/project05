...
<form action="" method="post">
	<fieldset>
		...
		<strong>Photo: *</strong> <input type="file" name="photo" value="<?php echo $photo; ?>"/><br><br>
		<h3>Write a couple sentences about yourself.</h3>
		<h4>For the sake of brevity, pretty please keep it to 80 words or under.</h4>
		<strong>Blurb About You: *</strong> <input type="text" name="info" value="<?php echo $info; ?>"/><br><br>
