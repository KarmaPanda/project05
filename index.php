    ...
    <div class="containerz">
        ...
        <div class="strong">
            <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]) { ?>
                <a href="portal.php" class="login-button">Admin</a>
        ...
        <div class="weak">
            <div class="z-page">
                ...
                <p>"Front-end" is an industry term that refers to the focus on HTML, CSS and JavaScript, which
                    ...
                    architecture, visual design, and use of client libraries (mostly JS); we will also cover Content
                    Management Systems and introduce web databases using PHP and MySQL.</p>
            </div>
        </div>
        <div class="terminal">
